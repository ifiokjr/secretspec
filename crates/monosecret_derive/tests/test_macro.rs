...
fn test_basic_secrets() {
	...
	// - struct Monosecret with api_key: String, database_url: String, optional_secret: Option<String>
	// - enum MonosecretProfile (empty since no profiles defined)
